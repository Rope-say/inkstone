...
## About
This project originates from [shuaiplus/inkstone](https://github.com/shuaiplus/inkstone), with modifications documented in [BRANDING_CHANGES.md](./BRANDING_CHANGES.md).
